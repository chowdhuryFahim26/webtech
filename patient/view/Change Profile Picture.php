...
<head>
    <title>Patient Profile Picture</title>
</head>
    ...
    <center>
        <table border="1" width="700px">
            ...
            <tr>
                ...
                <td>
                <fieldset>
			<legend>PATIENT PROFILE PICTURE:</legend>
			<table width="500px">
				<tr>
                    <td><img src="patient.jpg" alt="profile pic" style="width:100px;height:100px;"align="Left"></td>
				</tr>
                <tr>
